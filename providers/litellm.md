...
read_when:
  ...
  - 你需要通过 LiteLLM 进行费用追踪、日志记录或模型路由
---

# LiteLLM

[LiteLLM](https://litellm.ai) 是一个开源 LLM 网关，提供统一 API 接入 100+ 模型提供商。通过 LiteLLM 路由 OpenClaw，可以获得集中式费用追踪、日志记录，以及在不更改 OpenClaw 配置的情况下切换后端的灵活性。

## 为什么将 LiteLLM 与 OpenClaw 搭配使用？

- **费用追踪** — 精确查看 OpenClaw 在所有模型上的支出
...
- 所有 OpenClaw 功能都可以通过 LiteLLM 使用 — 没有限制
